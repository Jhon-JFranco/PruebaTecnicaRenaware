        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                ...
                <form class="needs-validation" novalidate method="POST"
                    action="{{route('cargos.update', $cargos->id_cargo)}}">
                    {!! method_field('PUT')!!}
                    @csrf
                    <div class="box">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="descripcion_cargo" class="form-control"
                                            id="validationTooltip04" placeholder="Ingrese Cargo"
                                            value="{{$cargos->descripcion_cargo}}" required>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        value="{{$cargos->salario}}" placeholder="Ingrese salario para este cargo" name="salario" required>
                                        <div class="invalid-feedback">
                                            Campo Obligatorio
                                        </div>
                                    </div>
